...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
        ...
        while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
            $sqlInsert = "INSERT into competence_bloc (id_bloc,id_formation, Nom)
                   values (".$column[0].",".$column[1].",'".utf8_decode($column[2])."')";
...
<body>
    <h2 align="center">Importation de données via un Fichier CSV</h2>
